...
- [ ] **Sponsor Outreach — ESG & Verified Impact**: Draft and send a persuasive sponsor recruitment email targeting beauty brands, property groups, and corporate ESG departments. Pitch: sponsors fund smart ventilation installs in nail salons and receive verified, immutable, auditable impact reports — not self-reported estimates. Key angles: (1) ESG reporting backed by real sensor data every 12 seconds, independently verifiable and tamper-proof; (2) direct social impact protecting salon workers (predominantly women/immigrants) from chemical fumes; (3) named attribution linking sponsor to specific salons and quantified pollutant removal. Founding sponsor cohort = small group of first movers. Draft email in conversation history from Feb 19, 2026.
